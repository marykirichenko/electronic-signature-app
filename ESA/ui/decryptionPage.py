...
class DecryptDocumentWindow(QWidget):
    def __init__(self, main_window):
        ...
        layout.addLayout(self.button_layout)  # Add button layout instead of self.button_layout
    ...
    def decrypt_file(self):
        ...
        if not self.pin:
            ...
            return
        try:
            EncryptionMechanism().decrypt(self.filename, self.pin)
            status_popup('File decrypted successfully')
        except Exception as e:
            status_popup('Error happened while decrypting file')
